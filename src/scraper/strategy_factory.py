...
from src.scraper.forhire_strategy import ForHireStrategy
from src.scraper.hnfreelance_strategy import HNFreelanceStrategy
...
STRATEGY_MAP = {
    ...
    "forhire": ForHireStrategy,
    "hnfreelance": HNFreelanceStrategy,
}
